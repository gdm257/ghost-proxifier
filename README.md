...
<p align="center">
  ...
  ·
  <a href="#why-ghost-proxifier">Why Ghost Proxifier</a>
  ·
...
Ghost Proxifier identifies known DoH server IPs (e.g., `8.8.8.8:443`, `1.1.1.1:443`) and returns `WSAECONNREFUSED` during `connect()`, forcing the browser to fall back to standard DNS — ensuring all DNS queries go through the Local DNS Proxy.
